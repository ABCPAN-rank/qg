 ...
 * @return is complete
 * @description init BinarySortTree
 */
 ...
 * @description insert a number in tree
 * @return is successful
 */
Status BST_insert(BinarySortTreePtr, SQElemType);

/**
 * BST delete
 * @param BinarySortTreePtr BST
 * @param ElemType the value for Node which will be deleted
 * @description delete a number which is in tree
 * @return is successful
 */
Status BST_delete(BinarySortTreePtr, SQElemType);

/**
 * BST search
 * @param BinarySortTreePtr BST
 * @param ElemType the value to search
 * @description search a value in tree
 * @return is exist
 */
NodePtr BST_search(NodePtr , SQElemType);

/**
 * BST preorder traversal without recursion
 * @param BinarySortTreePtr BST
 * @param (*visit) callback
 * @description Traver the tree without recursion
 * @return is successful
 */
